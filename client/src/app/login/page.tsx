    ...
    <div className={styles.page}>
      <div className={`card ${styles.card}`}>
        ...
        <div className={styles.copy}>
          <h1>Welcome to Wizee</h1>
          <p className="text-secondary">Sign in to start learning, or to pick up right where you left off.</p>
        </div>
        ...
        <p className={styles.fineprint}>
          By continuing you agree this is a work-in-progress MVP — things may break.
        </p>
      </div>
    </div>
  );
